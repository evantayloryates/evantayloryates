...
| [`operator-console-final`](./operator-console-final/README.md) | Final | Focused code-as-biography | The operator console with experiments and spatial demo removed |
...
- [Operator Console — 3D Systems Yard](./.archive/operator-console-with-3d/README.md)
